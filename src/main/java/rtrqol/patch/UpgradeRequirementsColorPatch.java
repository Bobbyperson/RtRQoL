...
/**
 * In the upgrade panel, colors resource costs and building requirements green
 * when the requirement is already met:
 *
 * - "Requires X for Y" lines (class-file line 134): green when the building
 *   that produces resource Y is currently built.
 * - Resource amounts like "8 Wood" (class-file line 146): green when the
 *   player already has enough of that resource in total.
 * - Required support building names (class-file line 192): green when any
 *   building in the required group is currently built.
 */
public class UpgradeRequirementsColorPatch implements ModPatch {
